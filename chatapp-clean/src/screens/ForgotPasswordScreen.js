...
export default function ForgotPasswordScreen({ navigation }) {
  ...
  const [backHovered, setBackHovered] = useState(false); // for web hover
  ...
  const handleSubmit = async () => {
    ...
    try {
      ...
      navigation.navigate(ROUTES.RESET_PASSWORD_OTP, { email });
    } catch (error) {
...
const styles = StyleSheet.create({
  ...
  title: {
    ...
    fontWeight: "700",
    color: "#e5e7eb",
    marginBottom: 18, // a bit more space now that subtitle is gone
  },
